...
./mkimage -A mips -O linux -T kernel -C lzma -a 0x80001000 -e 0x$($TARGET-nm vmlinux 2>/dev/null | grep "\bkernel_entry\b" | cut -f1 -d ' ') -n "Linux 3.10" -d ./vmlinux.bin.lzma uImage
