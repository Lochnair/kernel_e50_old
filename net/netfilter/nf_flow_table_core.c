...
extern int ip_fib_find_gateway(__be32 * gw, struct net_device * dev);
		      ...
		      enum flow_offload_tuple_dir dir)
{
	...
	/*
	 *	hwnat failure via multipath. Root cause is destination device in offload path 
	 *	and route gateway in dst cache are not in the same subnet.
	 *	Need to modify dev in dst_cache and rt_gateway.
	 */
